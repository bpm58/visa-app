// icon:exclamation-triangle-fill | Bootstrap https://icons.getbootstrap.com/ | Bootstrap
import * as React from 'react';

function IconExclamationTriangleFill() {
  return (
    <svg
      className='inline-block mr-2 fill-red-600'
      viewBox='0 0 16 16'
      height='1em'
      width='1em'
    >
...
export default IconExclamationTriangleFill;
